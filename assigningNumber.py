# # read data from csv and make a dictionary out of it
# import csv
# with open("unprocessed.csv",mode="r",newline="") as file:
#     read=csv.reader()
# # this is the mappings we use
# # Binary Mappings
...
# bin_data = ['school', 'sex', 'address', 'famsize', 'Pstatus', 'schoolsup', 
#                    'famsup', 'paid', 'activities', 'nursery', 'higher', 
#                    'internet', 'romantic', 'part_time_job']

# # keys of the dictionary as p
# # the dictionary itself be q
# # need a dictionary called nominal_data={column1:job_map}
# for i in p:
#     if i in bin_data:
#         for j in q[i]:
#             j=binary_map[j]
#     elif i in  nominal_data:
#         for j in q[i]:
#             j=nominal_data[i][j]
#     else:
#         pass        
...
# #  make a dictionary with the column header as keys and the column data as a tuple of values ,you read the value tuple and based on rules for each column header you apply the transformations.
